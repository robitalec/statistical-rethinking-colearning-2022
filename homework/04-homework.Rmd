...
in the same year. The data are found in data(cherry_blossoms). Consider at least
two functions to predict doy with temp. Compare them with PSIS or WAIC. Suppose
March temperatures reach 9 degrees by the year 2050. What does your best model
predict for the predictive distribution of the day-in-year that the cherry trees
will blossom?
...
```{r h04_q03_loo}
print(loo_compare(list(
  f1 = tar_read(loo_h04_q03_f1), 
  f2 = tar_read(loo_h04_q03_f2),
  f3 = tar_read(loo_h04_q03_f3)
)), simplify = FALSE)
```
